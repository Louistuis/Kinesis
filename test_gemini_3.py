...
history = [
    ...
    types.Content(role="model", parts=[
        types.Part.from_function_call(name="manage_tasks", args={"action": "add", "task_description": "play chess"}),
        types.Part.from_function_call(name="computer_use", args={"action": "left_click"})
    ]),
]

user_parts = [
    types.Part.from_function_response(name="manage_tasks", response={"status": "success"}),
    types.Part.from_function_response(name="computer_use", response={"error": "Blocked", "url": "http://localhost"}),
